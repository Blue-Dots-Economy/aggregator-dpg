...
`~/KKB/Github/2026-08-20-consent-ui-approaches.html` (approach E), using the real copy from
`config/blue_dot/schemas/participant/consent.json`. Not part of either PR.
