 ...
 *
 * Ported verbatim from Signals-DPG
 * `apps/ui/src/components/forms/custom-widgets/use-suggestion-keyboard.ts`.
 *
 * @module apps/web/components/forms/custom-widgets/use-suggestion-keyboard
 */
