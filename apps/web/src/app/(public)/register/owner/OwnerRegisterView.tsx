 ...
 * deep link (#619). Renders the brand shell around {@link OrgRegisterForm}. The
 * route that renders this view has already asserted the org hierarchy flag and
 * the presence of the org schema, so this view assumes the owner flow is live.
 *
...
export function OwnerRegisterView({
  ...
  return (
    <RegisterShell heading={t('owner_page_title')}>
      <OrgRegisterForm
        schema={schema}
        uiSchema={uiSchema}
