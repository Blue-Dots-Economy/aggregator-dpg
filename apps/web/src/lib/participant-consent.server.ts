...
interface ParticipantConsentFile {
  documents?: { terms?: ConsentDoc; privacy?: ConsentDoc };
}
 ...
 *
 * @returns The versioned Terms/Privacy content, or null when unavailable.
 */
export async function loadParticipantConsent(): Promise<ConsentDocContent | null> {
